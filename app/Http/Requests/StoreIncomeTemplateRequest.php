...
final class StoreIncomeTemplateRequest extends FormRequest
{
    public function prepareForValidation(): void
    {
        ...
        if ($this->input('series_id') === '' || $this->input('series_id') === null) {
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'series_id' => [
                'nullable',
                'integer',
                Rule::exists('income_template_series', 'id')->where('user_id', $userId),
            ],
